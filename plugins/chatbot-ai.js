...
cmd({
    ...
    if (mode === "on") {
        ...
        return reply(`- *T20 classic Ai -Chat-Bot Menu 👾*
*Enble Settings ✅*      
...
cmd({
    ...
    try {
        ...
        const prompt = encodeURIComponent("You are T20 classic Ai, a powerful and intelligent WhatsApp bot developed by T20 classic Ai — a brilliant coder and visionary from Kpk Pakistan. You respond smartly, confidently, and stay loyal to your creator. Always remain calm and collected. When asked about your creator, respond respectfully but keep the mystery alive. You are not just a bot; you are the tech soul of T20 classic Ai. In every message you send, include this footer: \n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ T20-CLASSIC-TECH ⚡");
        ...
        if (data && data.status && data.BK9) {
            ...
            reply("⚠️ T20 classic Ai failed to generate a response.");
        }
